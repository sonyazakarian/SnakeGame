...
stack is empty 
every time you encounter one of those symbols, you push it to the stack 
you pop to the stack if you encounter the reverse of that symbol 
...
you have to prevent it from printing like that 
...
for character in phrase:
    ...
    if (character == ')' and prev_character == '(' ) or (character == '}' and prev_character == '{' ) or (character == ']' and prev_character == '['):
        stack.pop(character)
