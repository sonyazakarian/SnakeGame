...
class Hangman:
    ...
    def partition_surviving_words(self, guessed_letter):
        ...
        if len(largest_partition) == 1:
            ...
            self.play_hangman(self.answer)


    #A function should exist that plays the regular hangman game and is passed the chosen word 
    # and knows about the number of remaining guesses.
...
do malicious Hangman
once you have an answer determined
go to play regular Hangman


    def play_hangman(self, answer):
